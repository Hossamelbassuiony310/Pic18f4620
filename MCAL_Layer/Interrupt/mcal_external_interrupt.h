...
#ifndef MCAL_EXTERNAL_INTERRUPT
#define	MCAL_EXTERNAL_INTERRUPT
...
/* This routine set the edge detect for the external interrupt to negative edge */
#define EXT_INT0_RisingEdgeSet()       (INTCON2bits.INTEDG0 = 1)
/* This routine set the edge detect for the external interrupt to positive edge */
...
#if INTERRUPT_FEATURE_ENABLE == INTERRUPT_PRIORITY_level_ENABLE
